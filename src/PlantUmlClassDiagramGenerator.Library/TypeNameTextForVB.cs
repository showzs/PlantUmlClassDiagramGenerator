...
{
    public class TypeNameTextForVB
    {
        ...
        public static TypeNameText From(TypeBlockSyntax syntax)
        {
            var identifier = syntax.BlockStatement.Identifier.Text;
            var typeArgs = string.Empty;
            var typeDeclaration = syntax.BlockStatement;
